...
![Image (AI description failed: Vision API failed after 3 attempts: Invalid JSON response from Vision API: Expecting value: line 1 column 1 (char 0))](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAABAAAAAQACAIAAADwf7zUAAAACX...)
